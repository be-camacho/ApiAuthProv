...
SECRET_KEY = 'django-insecure-y$k2ol!hmo^tahjbg9ozk66($a6n*0iracmf36z#76lr8l$zum'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST'),          # Endpoint de Aurora/RDS
        'PORT': os.getenv('DB_PORT', '3306'),  # Puerto (default: 3306)
        'OPTIONS': {
...
REST_FRAMEWORK = {
    'DEFAULT_PARSER_CLASSES': [
        'rest_framework.parsers.JSONParser',  # Asegúrate de que esta línea esté
